...
namespace SinavProjesi.Educator_UC
{
    public partial class UpdateQuestions_UC : UserControl
    {
        ...
        private void comboQuestionNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            answer = Convert.ToInt32(ds.Tables[0].Rows[0][5]);
            if (answer == 1) { txtAnswer.Text = txtOption1.Text; }
            else if(answer == 2) { txtAnswer.Text = txtOption2.Text; }
            else if (answer == 3) { txtAnswer.Text = txtOption3.Text; }
            else if (answer == 4) { txtAnswer.Text = txtOption4.Text; }                     
        }
