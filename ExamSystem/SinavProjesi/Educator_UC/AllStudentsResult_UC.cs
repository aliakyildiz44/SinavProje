...
namespace SinavProjesi.Educator_UC
{
    public partial class AllStudentsResult_UC : UserControl
    {
        ...
        private void comboSet_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                query = "select ResultId,ExamId,StudentId,StudentName,StudentSurname,TrueQuestionNumber,FalseQuestionNumber,NullQuestionNumber,AnsweredDate from Results where StudentId = '" + comboSet.Text + "'";
                DataSet ds = fn.GetData(query);
            ...
            {
                query = "select ResultId,ExamId,StudentId,StudentName,StudentSurname,TrueQuestionNumber,FalseQuestionNumber,NullQuestionNumber,AnsweredDate from Results";
                DataSet ds = fn.GetData(query);
                dgwStudentResult.DataSource = ds.Tables[0];
            }
        }
